...
type CreateOrderRequest struct {
	...
	Promocode         string                 `protobuf:"bytes,12,opt,name=Promocode,proto3" json:"Promocode,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_proto_cart_proto_rawDesc = "" +
	...
	"\x05Login\x18\x01 \x01(\tR\x05Login\"\x88\x03\n" +
	...
	"\x05Login\x18\v \x01(\tR\x05Login\x12\x1c\n" +
	"\tPromocode\x18\f \x01(\tR\tPromocode\"X\n" +
...
var file_proto_cart_proto_depIdxs = []int32{
	...
	0,  // 6: cart.CartService.GetCart:input_type -> cart.GetCartRequest
	1,  // 7: cart.CartService.UpdateItemQuantity:input_type -> cart.UpdateQuantityRequest
	2,  // 8: cart.CartService.ClearCart:input_type -> cart.ClearCartRequest
	3,  // 9: cart.CartService.CreateOrder:input_type -> cart.CreateOrderRequest
	4,  // 10: cart.CartService.GetOrders:input_type -> cart.GetOrdersRequest
	5,  // 11: cart.CartService.GetOrderById:input_type -> cart.GetOrderByIdRequest
	6,  // 12: cart.CartService.UpdateOrderStatus:input_type -> cart.UpdateOrderStatusRequest
	7,  // 13: cart.CartService.GetCart:output_type -> cart.CartResponse
	12, // 14: cart.CartService.UpdateItemQuantity:output_type -> google.protobuf.Empty
	12, // 15: cart.CartService.ClearCart:output_type -> google.protobuf.Empty
	9,  // 16: cart.CartService.CreateOrder:output_type -> cart.OrderResponse
	10, // 17: cart.CartService.GetOrders:output_type -> cart.OrderListResponse
	9,  // 18: cart.CartService.GetOrderById:output_type -> cart.OrderResponse
	12, // 19: cart.CartService.UpdateOrderStatus:output_type -> google.protobuf.Empty
